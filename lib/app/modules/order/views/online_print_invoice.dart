...
import '../../../data/model/response/order_details_model.dart' as order;

import 'package:pdf/pdf.dart';
import 'package:pdf/widgets.dart' as pw;
import 'package:printing/printing.dart';

class OnlinePrintInvoice extends StatefulWidget {
  final info.Data? comapnyInfo;
  final order.Data? orderDetails;
  const OnlinePrintInvoice({
    super.key,
  ...
  @override
  State<OnlinePrintInvoice> createState() => _OnlinePrintInvoiceState();
}

class _OnlinePrintInvoiceState extends State<OnlinePrintInvoice> {
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Center(
                        child: Text(
                          widget.orderDetails!.branch!.address.toString(),
                          textAlign: TextAlign.center,
                          style: GoogleFonts.ptSans(
                            color: AppColor.fontColor,
                              ...
                              Expanded(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      widget.orderDetails!.paymentStatus ==
                                              ...
                                              widget
                                                  ...
                                                  null
                                          ? 'CASH_ON_DELIVEY'.tr
                                          : widget.orderDetails!.transaction !=
                                              null
                                          ? widget
                                              .orderDetails!
                                              .transaction!
                                    ...
                                    SizedBox(height: 4.h),
                                    Text(
                                      widget.orderDetails!.deliveryDate
                                              .toString() +
                                          " " +
                                          widget.orderDetails!.deliveryTime
                                              .toString(),
                                      style: GoogleFonts.ptSans(
                                        color: AppColor.fontColor,
                                        fontWeight: FontWeight.w400,
                            ...
                            children: [
                              ...
                              Expanded(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      widget.orderDetails!.user!.firstName
                                              .toString() +
                                          ' ' +
                                          widget.orderDetails!.user!.lastName
                                              .toString(),
                                      style: GoogleFonts.ptSans(
                                        color: AppColor.fontColor,
                                        fontWeight: FontWeight.w400,
                                    ...
                                    SizedBox(height: 4.h),
                                    Text(
                                      widget.orderDetails!.user!.countryCode
                                              .toString() +
                                    ...
                                    SizedBox(height: 4.h),
                                    Text(
                                      '${widget.orderDetails!.orderAddress!['apartment']}, ${widget.orderDetails!.orderAddress!['address']}',
                                      style: GoogleFonts.ptSans(
                                        color: AppColor.fontColor,
                                        fontWeight: FontWeight.w400,
                                        fontSize: 11.sp,
