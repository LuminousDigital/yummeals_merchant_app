...
import 'package:foodking_admin/app/modules/order/views/pos_order_details.dart';
import 'package:foodking_admin/util/constant.dart';
import 'package:get/get.dart';
import 'package:get_storage/get_storage.dart' as save;
import 'package:google_fonts/google_fonts.dart';

import '../../../data/model/response/pos_orders_model.dart';

class POS extends StatefulWidget {
  const POS({super.key, required this.order});
  final Data order;
