...
import 'package:foodking_admin/app/data/model/response/language_model.dart';
...
class SplashController extends GetxController {
      ...
      await server.getRequestWithoutToken(endPoint: APIList.configuration).then(
        (response) {
          if (response != null && response.statusCode == 200) {
            ...
            currency = configData.siteDefaultCurrencySymbol.toString();
            update();
            box.write(
              "countryCodeName",
  ...
  getLanguageData() async {
    ...
    final list = langData.data ?? <LanguageData>[];
    languageDataList = list;
    update();
  }
}
